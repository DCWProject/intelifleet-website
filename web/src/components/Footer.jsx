    ...
    <footer className="bg-gray-50 dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            ...
            <div className="flex space-x-3">
              {socialLinks.map((social) => (
                <a
                  key={social.label}
                  href={social.href}
                  className="text-gray-400 hover:text-navy dark:hover:text-primary transition-colors"
          ...
          {/* Products */}
          <div>
            <h3 className="text-sm font-semibold text-navy dark:text-white uppercase tracking-wider mb-4">
            ...
            <ul className="space-y-2">
              {footerLinks.products.links.map((link) => (
                <li key={link.path}>
                  <Link 
                    to={link.path}
                    className="text-sm text-gray-500 dark:text-gray-400 hover:text-navy dark:hover:text-primary transition-colors"
                  >
                    {link.name}
                  </Link>
                </li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-sm text-gray-400 dark:text-gray-500 mt-2 md:mt-0">
              Built in India 🇮🇳
            </p>
          </div>
        </div>
