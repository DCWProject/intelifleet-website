    ...
    <div className="bg-white dark:bg-gray-900 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 mb-16">
          <h2 className="text-2xl font-semibold text-navy dark:text-white mb-8 text-center">Industries We Serve</h2>
          <div className="grid md:grid-cols-5 gap-4">
            {industries.map((i) => (
              <div key={i.name} className="text-center">
                <p className="text-3xl font-bold text-primary mb-1">{i.percentage}</p>
                <p className="text-sm text-gray-600 dark:text-gray-400">{i.name}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {testimonials.map((t) => (
            <div key={t.author} className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-100 dark:border-gray-700">
              ...
              <div className="flex items-center">
                <div className="w-12 h-12 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center mr-4">
                  <span className="text-lg font-semibold text-gray-500 dark:text-gray-400">{t.author[0]}</span>
                </div>
                <div>
