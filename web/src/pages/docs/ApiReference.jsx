  ...
  return (
    <div className="bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <h1 className="text-4xl font-bold text-navy mb-4">API Reference</h1>
        ...
        {/* Auth Section */}
        <div className="mb-12">
          <h2 className="text-2xl font-semibold text-navy mb-4">Authentication</h2>
        ...
        {/* Endpoints */}
        <div className="mb-12">
          <h2 className="text-2xl font-semibold text-navy mb-4">Endpoints</h2>
          
          <div className="space-y-4">
            {endpoints.map((ep) => (
              <div key={ep.path} className="border border-gray-200 rounded-xl p-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <code className="text-navy font-mono">{ep.path}</code>
                </div>
        ...
        <div className="bg-gray-50 rounded-2xl p-8">
          <h2 className="text-2xl font-semibold text-navy mb-4">Rate Limits</h2>
          
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-white rounded-lg p-4">
              <p className="font-semibold text-navy">Basic</p>
            ...
            <div className="bg-white rounded-lg p-4">
              <p className="font-semibold text-navy">Enterprise</p>
