...
import { ArrowLeft, Bus, Clock, Users, Shield } from 'lucide-react';
    ...
    <div className="bg-white dark:bg-gray-900 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <div>
            <div className="inline-flex items-center justify-center w-16 h-16 bg-purple-50 dark:bg-purple-900/30 rounded-2xl mb-6">
          ...
          <div className="bg-gray-100 dark:bg-gray-800 rounded-2xl h-80 flex items-center justify-center">
            <Bus className="h-24 w-24 text-gray-300 dark:text-gray-600" />
          </div>
        </div>
